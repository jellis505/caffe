 ...
 */
template <typename Dtype>
class MilCropImageDataLayer : public BasePrefetchingDataLayer<Dtype> {
 public:
  explicit MilCropImageDataLayer(const LayerParameter& param)
      : BasePrefetchingDataLayer<Dtype>(param) {}
  virtual ~MilCropImageDataLayer();
  virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
